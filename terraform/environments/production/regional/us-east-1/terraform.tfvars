# Regional Configuration for Production us-east-1
...
regional_s3_buckets = {
  regional-artifacts = {
    purpose                      = "Regional artifacts and logs for production us-east-1"
  ...
  alb-access-logs = {
    purpose                      = "ALB access logs for production us-east-1"
    force_destroy               = false
